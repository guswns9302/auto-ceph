...
`리뷰 요청` 단계에서는 `.auto-ceph-work/scripts/create_or_reuse_merge_request.js` canonical helper로 Merge Request를 조회/생성하고 `07_SUMMARY.md`의 `## Merge Request` 섹션에 결과를 기록한다.
