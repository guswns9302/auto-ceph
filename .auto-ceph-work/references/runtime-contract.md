...
- `리뷰 요청` 단계는 `07_SUMMARY.md` 기본 요약 작성, ticket branch commit, push, canonical helper 기반 MR 생성 또는 재사용, helper 결과의 `07_SUMMARY.md` 반영, Jira description 최종 동기화까지 끝나야 완료다.
